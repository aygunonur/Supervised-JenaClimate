...
model = Sequential(name='Jena-Climate-BidirectionalLSTM')
model.add(Bidirectional(LSTM(64, activation='tanh', name='LSTM'), input_shape=(None, training_dataset_x.shape[1]), name='Bidirectional'))
