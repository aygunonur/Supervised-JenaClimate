...
model = Sequential(name='Jena-Climate-WithGenerator')
model.add(LSTM(64, input_shape=(LOOKBACK_INTERVAL, training_dataset_x.shape[1]), name='LSTM'))
...
print(f'Real result: {dataset_x[555 + PREDICT_INTERVAL][1]}')